...
const RegisterForm = () => {
    ...
    const handleRegister = async (event) => {
        ...
        setLoading(true)
        try {
            const response = await fetch(`${NEXT_URI}/api/auth/register`, {
                method: "POST",
    ...
    return (
        <form className="md:col-span-2 w-full py-6 px-6 sm:px-16" onSubmit={handleRegister}>
            <div className="mb-6">
            ...
            <div className="!mt-6">
                <button type="submit" disabled={loading} className="disabled:bg-primary/70 disabled:cursor-not-allowed w-full py-3 px-4 tracking-wider text-sm rounded-md text-white bg-primary hover:bg-primary/90 focus:outline-none">
